...
class Program(object):
	def __init__(self):
		...
		self._backupDbName = "cd2"
		self._strCon = "Data Source=192.168.1.77,8033;Initial Catalog=master;User ID=sa;Password=qazwsxedc" # Change SQLDBSERVER to the name of the SQL Server you are using
		self._LogFile = "SQLBackup.log" # The location on the local Drive of the log files.
		self._backupDir = "\\\\192.168.1.77\\d$\\Backup\\" # The local drive to save the backups to 
